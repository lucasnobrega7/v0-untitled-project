          ...
          <TabsContent value="overview" className="space-y-4 mt-4">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  A integração entre a plataforma Agentes de Conversão e o N8N oferece diversas vantagens:
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong>Integração com múltiplos sistemas</strong>: Conecte seus agentes com dezenas de outras ferramentas e serviços
                  </li>
                  <li>
                ...
                <div className="bg-muted p-4 rounded-md">
                  <p className="mb-2">A integração entre Agentes de Conversão e N8N funciona principalmente de duas formas:</p>
                  
                  <ol className="list-decimal pl-6 space-y-2">
                    <li>
                      <strong>Webhooks</strong>: O N8N recebe eventos da plataforma Agentes de Conversão através de webhooks
                    </li>
                    <li>
                  ...
                  <p className="mt-2">
                    Essa abordagem permite tanto fluxos reativos (acionados por eventos) quanto proativos (iniciados pelo N8N).
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <ol className="list-decimal pl-6 space-y-2">
                  <li>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Acesse o painel da plataforma Agentes de Conversão, vá para Configurações > API e gere uma nova API Key.
                    </p>
                  </li>
                  <li>
                ...
                <Alert className="mt-4">
                  ...
                  <AlertDescription>
                    Recomendamos configurar um segredo para seus webhooks e validar a assinatura no N8N 
                    para garantir a autenticidade das requisições.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
          ...
          <TabsContent value="webhooks" className="space-y-4 mt-4">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p>
                  Para garantir a segurança, você deve validar a assinatura do webhook. Adicione um nó "Function" 
                  após o webhook para verificar a assinatura:
                </p>
...
if (signature === expectedSignature) {
  ...
  throw new Error('Assinatura de webhook inválida');
                ...
                <p>
                  Após obter a URL do webhook no N8N, você precisa configurá-la na plataforma Agentes de Conversão:
                </p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p>
                  Todos os eventos enviados pela plataforma Agentes de Conversão seguem uma estrutura comum:
                </p>
                ...
                <p>
                  Para processar diferentes tipos de eventos, você pode usar um nó "Switch" no N8N:
                </p>
                ...
                <p className="mt-4">
                  Após o nó Switch, você pode adicionar diferentes fluxos para cada tipo de evento, 
                  permitindo um processamento específico para cada caso.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="examples" className="space-y-4 mt-4">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <p>
                  Este fluxo monitora eventos do tipo <code>agent.action</code> com ação "qualificar_lead" 
                  e notifica a equipe de vendas quando um lead é classificado como "quente".
                </p>
...
👉 *Detalhes da conversa:* {{$node["HTTP Request"].json.conversation_url}}`}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <h3 className="text-lg font-medium">Descrição do Fluxo</h3>
                <p>
                  Este fluxo sincroniza conversas e mensagens com um sistema de CRM, mantendo um registro 
                  completo das interações dos agentes com os clientes.
                </p>
                ...
                <ol className="list-decimal pl-6 space-y-2">
                  ...
                  <li>
                    <strong>HTTP Request (Registrar Interação)</strong>: Registra a conversa ou mensagem no histórico do cliente
                  </li>
                </ol>
                ...
                <p>
                  Use um nó "Function" para transformar os dados do evento no formato esperado pelo CRM:
                </p>
    ...
    conversation_id: data.conversation_id
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Fluxo para analisar o sentimento das conversas e alertar para casos de insatisfação</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <h3 className="text-lg font-medium">Descrição do Fluxo</h3>
                <p>
                  Este fluxo analisa o sentimento das mensagens dos usuários e alerta a equipe 
                  quando detecta insatisfação, permitindo intervenção rápida.
                </p>
                ...
                <p>
                  Você pode usar serviços como Google Cloud Natural Language API, Azure Text Analytics, 
                  ou Amazon Comprehend para análise de sentimento:
                </p>
