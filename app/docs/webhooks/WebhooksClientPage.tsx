          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li>
                  Quando um desses eventos ocorre (ex: nova mensagem), nosso sistema envia uma requisição HTTP POST para
                  sua URL
                </li>
            ...
            <CardContent className="space-y-4">
              ...
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li>
                  ...
                  <p className="text-sm text-muted-foreground">
                    No painel da plataforma Agentes de Conversão, vá para o agente desejado e acesse a seção "Webhooks".
                  </p>
                </li>
                <li>
        ...
        <TabsContent value="events" className="space-y-4 mt-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p>
                Todos os eventos seguem uma estrutura comum, com um campo <code>event</code> indicando o tipo de evento
                e um campo <code>data</code> contendo os detalhes específicos:
              </p>
        ...
        <TabsContent value="security" className="space-y-4 mt-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p>
                Para garantir que as requisições recebidas são autênticas e vêm da plataforma Agentes de Conversão, você
                deve validar a assinatura incluída no cabeçalho <code>X-Webhook-Signature</code>.
              </p>
...
app.post('/webhooks/agentes-conversao', (req, res) => {
  ...
  res.status(200).send('OK');
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>HTTPS</strong>: Use sempre HTTPS para seu endpoint de webhook para garantir que os dados sejam
                ...
                <li>
                  <strong>Idempotência</strong>: Trate os eventos de forma idempotente, pois podem ser enviados mais de
                  uma vez em caso de falhas
                </li>
                <li>
                  <strong>Validação de dados</strong>: Sempre valide os dados recebidos antes de processá-los
                </li>
                <li>
                  <strong>Logs</strong>: Mantenha logs detalhados das requisições de webhook para facilitar a depuração
                </li>
              </ul>
              ...
              <Alert className="mt-4">
                ...
                <AlertTitle>Importante</AlertTitle>
                <AlertDescription>
                  Nunca compartilhe seu segredo de webhook. Se suspeitar que ele foi comprometido, gere um novo segredo
                  imediatamente nas configurações do webhook.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Considere usar serviços como AWS SQS, RabbitMQ ou Kafka para garantir o processamento confiável</li>
              </ul>
            </CardContent>
          </Card>
        </TabsContent>
